...
$ ./ncadm -h
NAME:
   ncadm - ncadm, a commond-line tool to control join to litekube network-controller
...
GLOBAL OPTIONS:
   ...
   --cacert value    ca cert filepath of network grpc server (default: "/Users/zhujianxing/nc/certs/grpc/ca.pem")
   --cert value      client cert filepath of network grpc server (default: "/Users/zhujianxing/nc/certs/grpc/client.pem")
   --key value       client key filepath of network grpc server (default: "/Users/zhujianxing/nc/certs/grpc/client-key.pem")
